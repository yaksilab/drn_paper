%nuc_axo - One line description of what the script performs (H1 line)
...
%
sav_ima_gfa_all(nuc_axo)% gfap
%
sta_ani = 3;
app_axo_all(nuc_axo, sta_ani)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 2025 w12
sta_ani = 1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 2025 w26
sta_ani = 6;
sav_fig_cor_map_ove_spo_all(nuc_axo, sta_ani)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 2025 w40
