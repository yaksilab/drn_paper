function sav_fig_neu(fil_pat_neu, fil_pat_fig, col_han_pos, tit, fon_siz)
...
load(fil_pat_neu, 'ima_ref', 'ima_fir', 'ima_ave')
n_exp = length(tit);
for i = 1:n_exp
    sav_fig(ima_ref, ima_fir(:, :, i), ima_ave(:, :, i), fil_pat_fig{i}, col_han_pos, tit(i), fon_siz)
end
end

function sav_fig(ima_ref, ima_fir, ima_ave, fil_pat_fig, col_han_pos, tit, fon_siz)
fig
