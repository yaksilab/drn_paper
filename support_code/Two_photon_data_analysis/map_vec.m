classdef map_vec
    ...
    methods(Static)
        ...
        % cel
        function clu = cel_onl_cel_bou_all(clu)
            if clu == 1
                clu = 1;
            elseif clu == 5
                clu = 2;
        ...
        %
        function clu = cel_onl_cel_bou_spo(clu)
            if clu == 3
                clu = 1;
            elseif clu == 1
                clu = 2;
