function [mixedsig, mixedfilters, CovEvals, covtrace, movm, movtm] = CellsortPCA(im, flims, nPCs, ...
    dsamp, badframes)
% [mixedsig, mixedfilters, CovEvals, covtrace, movm, movtm] = CellsortPCA(fn, flims, nPCs, dsamp, ...
% outputdir, badframes)
%
% CELLSORT
...
[covmat, mov, movm, movtm] = create_tcov(im, pixw, pixh, useframes, nt, dsamp);
...
mixedfilters = reshape(mixedfilters, pixw,pixh,nPCs);
    ...
    function [covmat, mov, movm, movtm] = create_tcov(im, pixw, pixh, useframes, nt, dsamp)
        %-----------------------
