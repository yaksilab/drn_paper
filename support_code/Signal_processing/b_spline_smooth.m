...
%					    quintic, and heptic splines respectively. Spline degree = 
%				        2%half_order - 1.
%					  
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% 1.) Woltring 1985-07-04. Original FORTRAN code. 
%
% 2.) D. Twisk 1994.  Translation to C of the Woltring code. GOTO's and 
%	   labels have been eliminated.
%
% 1.) William Dickson 2002. Added Matlab mex wrapper. Corrected pointer 
%     error in gcvspl - w.r.t I/O variables var and ier. 
% 