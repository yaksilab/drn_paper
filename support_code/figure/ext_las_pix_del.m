function [las_pix, rat_wid] = ext_las_pix_del(pos_axe, fig_wid, del_axe)
...
%   All rights reserved.
las_rat_axe = cellfun(@(pos_ind) pos_ind(1) + pos_ind(3), pos_axe);
las_rat_axe(del_axe) = [];
rat_wid = max(las_rat_axe);
las_pix = round(rat_wid*fig_wid) + 13;
