classdef sigstar
    %SIGSTAR - One line description of what the class performs (H1 line)
    %   Optional file header info (to give more details about the function than in the H1 line)
    %   Optional file header info (to give more details about the function than in the H1 line)
    %   Optional file header info (to give more details about the function than in the H1 line)
    %
    %   SIGSTAR constructor syntax:
    %       SIGSTAR_OBJ = SIGSTAR()
    %
    %   SIGSTAR properties/attributes:
    %       Property 1 - description
    %       Property 2 - description
    %
    %   SIGSTAR methods/functions:
    ...
    %   Date: 16-Apr-2024; Last revision: 16-Apr-2024
    %
    ...
    methods(Static)
        function [H, y_lim] = sig(hax, groups, y_lim_pre, sep, mou, ext_hei, offset, stats, nosort)
        ...
        %-----------------------------------------------------
            ...
            % printing
            for ii=1:length(groups)
                H(ii,:) = makeSignificanceBar.sig(xlocs(ii,:), thi_gro(ii), stats(ii), y_lim_pre, ...
                    offset);
            end
            %-----------------------------------------------------
