function plo_spi_ras_nov_col(spi_sta, spi_dev, spi_con_nov, spi_nov, x_lim, col_sta, col_dev, col_con_nov, col_nov)
...
relSpikeStartTime = 0;
    ...
    n_tri_nov = length(spi_nov);
        ...
        plot(x_sta, y_sta, col_sta);
        hold on
        plot(x_dev, y_dev, col_dev);
        hold on
        plot(x_con_nov, y_con_nov, col_con_nov);
        hold on
        plot(x_nov, y_nov, col_nov);
