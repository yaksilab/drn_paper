function [all_fish]=aj_accelerationPlot_2groups(all_fish,nROIs,timebin,folder_path,folder_path_save,fish_name,date_exp,figures_subfolder,group1,group2,allgroups,name_group1,name_group2)
...
xlabel(['Mean acceleration, ' ,num2str(name_group1)]);
