function [all_fish] = aj_evokedBdeepAnalysis_4groups_25L...
...
for i=1:size(idxLightsOn,2)
    ...
    for ROI=1:nROIs
        ...
        velocity_243HZ  = all_fish{ROI,1}.binnedVel2_43Hz;
       ...
       temp5   = (Burst_binary(...
        ...
        temp121   = (velocity_243HZ(...
            t2 >= floor(timeLight(idxLightsOn(ROI,i))) &...
            t2 <= floor(timeLight(idxLightsOn(ROI,i))+10+115) )); %% til 50 seconds after
...
tempVelMat = nan(nROIs,2655);

for ROI = 1:nROIs
    VelVec = [];
    VelVec(1,:) = (all_fish{ROI,1}.bV_E4sd...
        (1,round(all_fish{ROI, 1}.timestampLight(idxLightsOn(ROI,1)-30))...
        :round(all_fish{ROI, 1}.timestampLight(idxLightsOff(ROI,25))+30)...
        ));
    
    tempVelMat (ROI,:) = interp1(1:length(VelVec),VelVec,(1:1:2655)); 
end
...
for i=1:5
    ...
    for ROI=1:nROIs
        ...
        t2                  = all_fish{ROI, 1}.t2;
        binnedVel2_43Hz    = all_fish{ROI, 1}.binnedVel2_43Hz;
