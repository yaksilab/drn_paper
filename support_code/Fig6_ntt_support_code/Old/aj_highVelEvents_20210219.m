function [all_fish]=aj_highVelEvents_20210219(all_fish,nROIs,timebin,folder_path_save,fish_name,date_exp,figures_subfolder,group1,group2,allgroups,name_group1,name_group2,highVel_thresholds)
...
for j= 1:length(highVel_thresholds)
    ...
    for ROI=1:nROIs
        ...
        %load variables
        meanVelbinned   = all_fish{ROI,1}.bV_E4sd;
        ...
        if isnan(nanmean(all_fish{ROI,1}.bV_E4sd(:,:),2))
