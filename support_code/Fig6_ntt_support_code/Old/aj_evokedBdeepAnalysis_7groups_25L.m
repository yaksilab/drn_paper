function [all_fish] = aj_evokedBdeepAnalysis_7groups_25L...
...
tempMat2 = (tempVelMat([group1,group2,group3,group4,group5,group6],:));
tempMat3 = mean (tempVelMat,2,'omitnan');

f5= figure;
f5.WindowState = 'Maximized';
subplot (2,6,[1:2,7:8])
boxplot (tempMat3([groups{1,1:6}],:),...
    string(group_category (1,[groups{1,1:6}])),...
...
imagesc (tempMat2(1:length([groups{1,1:6}]),:))
