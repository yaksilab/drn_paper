...
f8 = tiledlayout(1,2)%size(idxLightsOn,2)/5); % Requires R2019b or later
% title(f8,['ON response']);
% . Average number of responders (+2SD)'...
%     ', depressed (-2SD), and non-response (in between) ']))
% ylabel(f8,'Proportion')
f8.Padding = 'compact';
f8.TileSpacing = 'compact';
...
%     legend ({'Activated', 'Inhibited', 'Non-responding'},'Location','northwest')
end
 
% formats = {'.fig' '.jpg' '.svg'};
% for f=1:length(formats)
%     if strcmp (fish_name, 'PTZ')
%         saveas(f8,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\PTZ\for_Fig2\' 'Fig2_responders_On' formats{1,f}])
%     elseif strcmp (fish_name, 'PTZ_short')
%         saveas(f8,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\PTZ_s\for_Fig2\' 'Fig2_responders_On' formats{1,f}])
%     elseif strcmp (fish_name, 'eaat2a')
%         saveas(f8,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\Eaat2a\for_Fig2\' 'Fig2_responders_On' formats{1,f}])
%     elseif strcmp (fish_name, 'gabra1')
%         saveas(f8,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\gabra1\for_Fig2\' 'Fig2_responders_On' formats{1,f}])
%     elseif strcmp (fish_name, 'scn1lab')
%         saveas(f8,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\Scn1lab\for_Fig2\' 'Fig2_responders_On' formats{1,f}])
%     elseif strcmp (fish_name, 'S280F')
%         saveas(f8,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\s280f\for_Fig2\' 'Fig2_responders_On' formats{1,f}])
%     end
% end
...
% for f=1:length(formats)
%     if strcmp (fish_name, 'PTZ')
%         saveas(f9,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\PTZ\for_Fig2\' 'Fig2_responders_OnLate' formats{1,f}])
%     elseif strcmp (fish_name, 'PTZ_short')
%         saveas(f9,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\PTZ_s\for_Fig2\' 'Fig2_responders_OnLate' formats{1,f}])
%     elseif strcmp (fish_name, 'eaat2a')
%         saveas(f9,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\Eaat2a\for_Fig2\' 'Fig2_responders_OnLate' formats{1,f}])
%     elseif strcmp (fish_name, 'gabra1')
%         saveas(f9,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\gabra1\for_Fig2\' 'Fig2_responders_OnLate' formats{1,f}])
%     elseif strcmp (fish_name, 'scn1lab')
%         saveas(f9,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\Scn1lab\for_Fig2\' 'Fig2_responders_OnLate' formats{1,f}])
%     elseif strcmp (fish_name, 'S280F')
%         saveas(f9,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\s280f\for_Fig2\' 'Fig2_responders_OnLate' formats{1,f}])
%     end
% end
...
% for f=1:length(formats)
%     if strcmp (fish_name, 'PTZ')
%         saveas(f10,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\PTZ\for_Fig2\' 'Fig2_responders_Off' formats{1,f}])
%     elseif strcmp (fish_name, 'PTZ_short')
%         saveas(f10,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\PTZ_s\for_Fig2\' 'Fig2_responders_Off' formats{1,f}])
%     elseif strcmp (fish_name, 'eaat2a')
%         saveas(f10,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\Eaat2a\for_Fig2\' 'Fig2_responders_Off' formats{1,f}])
%     elseif strcmp (fish_name, 'gabra1')
%         saveas(f10,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\gabra1\for_Fig2\' 'Fig2_responders_Off' formats{1,f}])
%     elseif strcmp (fish_name, 'scn1lab')
%         saveas(f10,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\Scn1lab\for_Fig2\' 'Fig2_responders_Off' formats{1,f}])
%     elseif strcmp (fish_name, 'S280F')
%         saveas(f10,['\\forskning.it.ntnu.no\ntnu\mh-kin\yaksi\Ahmed\Behaviour',...
%             '\Larvae\figures\s280f\for_Fig2\' 'Fig2_responders_Off' formats{1,f}])
%     end
% end
% 
