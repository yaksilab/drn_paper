...
VelISI_3Dmat_meanISI5=mean(VelISI_3Dmat(:,:,1:5),3); %calc mean ISI5 (for PTZ_short!)
...
%     Vec{i,1}(:,j) = ([peakAnalysisCell_perISI{i, 1}.latency]);                         % something is wrong works only for the 5 min ISI
    ...
    %Vec2 = mean(Vec{i,1},2);
    b= boxchart(Vec([groups{1,1:4}],:),'BoxWidth',.5,'BoxFaceAlpha',0.5,'LineWidth',.5,'MarkerStyle','none',...
        'GroupByColor',group_category([groups{1,1:4}],:));
    set(b,{'BoxFaceColor'},C1)
